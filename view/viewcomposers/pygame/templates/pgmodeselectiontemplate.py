...
class PyGameModeSelectionTemplate(ITemplate):
    ...
    def initialize(self, screen: Screen, mediapath: str,
        ...
        self._mediapath = mediapath + PyGameModeSelectionTemplate._MEDIAPATH
        ...
        self._nameframe = pygame.image.load(self._mediapath + 'modenameframe.png')
        ...
        self._descriptionframe = pygame.transform.scale(self._descriptionframe,
                                                        PyGameModeSelectionTemplate._DESCRIPTIONSIZE)
        ...
        self._matchmakingbutton = pygame.image.load(self._mediapath + 'findmatchbutton.png')
        self._matchmakingbutton = pygame.transform.scale(self._matchmakingbutton,
                                                         PyGameModeSelectionTemplate._BUTTONSSIZE)
        self._backbutton = pygame.image.load(self._mediapath + 'backbutton.png')
    ...
    def print(self):
        ...
        numplayerposition = (descriptionframeposition[0] + descriptionframeposition[0] / 7,
                             descriptionframeposition[1] + (
                                 PyGameModeSelectionTemplate._DESCRIPTIONSIZE[1] - numplayerheight) / 4)
        ...
        durationposition = (numplayerposition[0],
                            numplayerposition[1] + (
                                PyGameModeSelectionTemplate._DESCRIPTIONSIZE[1] - durationheight) / 5)
        ...
        mapdimensionsposition = (numplayerposition[0],
                                 durationposition[1] + (
                                     PyGameModeSelectionTemplate._DESCRIPTIONSIZE[1] - mapdimensionsheight) / 5)
        ...
        matchmakingbuttonposition = (
            nameframeposition[0] + PyGameModeSelectionTemplate._NAMEFRAMESIZE[0] -
            PyGameModeSelectionTemplate._BUTTONSSIZE[
                0],
            descriptionframeposition[1] + PyGameModeSelectionTemplate._DESCRIPTIONSIZE[1] + framestep)
